...
For the non-thresholded gene set enrichment analysis (GSEA), we selected the newest released GMT file **Human_GO_AllPathways_noPFOCR_no_GO_iea_March_02_2026_symbol.gmt** from BaderLab Gene Sets [@BaderLab_GeneSets]. 
...
```{r GSEA initiation, message = FALSE}
...
gmt_file_name <- "Human_GO_AllPathways_noPFOCR_no_GO_iea_March_02_2026_symbol.gmt"
setwd("/home/rstudio/projects/A2")
data_dir <- "./data"
...
# URL for download
gmt_url <- paste0("http://download.baderlab.org/EM_Genesets/current_release/Human/symbol/", gmt_file_name)
